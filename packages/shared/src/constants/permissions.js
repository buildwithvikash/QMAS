...
export const PERMISSION_DEFINITIONS = Object.freeze([
  { key: PERMISSIONS.DASHBOARD_VIEW, module: 'Home', description: 'View dashboard and own task list' },
  { key: PERMISSIONS.USERS_VIEW, module: 'Administration', description: 'View users and their role assignments' },
  { key: PERMISSIONS.USERS_MANAGE, module: 'Administration', description: 'Create and edit users, assign roles, reset passwords' },
  { key: PERMISSIONS.ROLES_MANAGE, module: 'Administration', description: 'Change the permissions granted to each role' },
  { key: PERMISSIONS.MASTERS_VIEW, module: 'Master Config', description: 'View master data' },
  { key: PERMISSIONS.MASTERS_MANAGE, module: 'Master Config', description: 'Create and edit master data' },
  ...
  { key: PERMISSIONS.AUDIT_VIEW, module: 'Administration', description: 'View the audit trail' },
  ...
  { key: PERMISSIONS.IMIR_INSPECT, module: 'Incoming Inspection', description: 'Record observations and submit IMIRs' },
  ...
  { key: PERMISSIONS.DN_MANAGE, module: 'Defect Notification', description: 'Raise DNs and upload CAPA' },
  ...
  { key: PERMISSIONS.INTEGRATION_MONITOR, module: 'Administration', description: 'View SAP / Windchill / SAN-SIR sync status' },
...
export const DEFAULT_ROLE_PERMISSIONS = Object.freeze({
  ...
  [ROLES.IQC_HEAD]: [...VIEW_ALL, P.FORMATS_CREATE, P.FORMATS_APPROVE, P.IMIR_HEAD_DECIDE, P.DEVIATION_FINAL_DECIDE, P.DN_APPROVE_CAPA, P.SAMPLING_MANAGE],
